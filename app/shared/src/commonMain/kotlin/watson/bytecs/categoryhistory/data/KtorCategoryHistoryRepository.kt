 ...
 *  - `GET {baseUrl}/api/learning-history/problems/{id}` 푼 문제 하나 단건 재열람(DI10)
 *
...
class KtorCategoryHistoryRepository(
    ...
    override suspend fun getSolvedProblem(problemId: Long): CategoryHistoryItem {
        val dto: CategoryHistoryItemDto = client.get("$baseUrl/api/learning-history/problems/$problemId").body()
        return dto.toDomain()
    }
}
